export const website1 = [
    ...
    [
        {
            logo: '/front-end/statistic/other/Playwright.svg',
            name: 'Playwright',
    ...
    ],
    {
        logo: '',
        name: 'Pyppeteer',
        url: 'https://pyppeteer.github.io/pyppeteer',
        description: '无头chrome/chromium自动化库',
        github: 'https://github.com/pyppeteer/pyppeteer'
    },
    {
        logo: '/front-end/statistic/other/Selenium.ico',
        name: 'Selenium',
    ...
    {
        logo: '/front-end/statistic/other/Appium.png',
        name: 'Appium',
...
export const website2 = [
    // 工具库
    {
        logo: '/front-end/statistic/other/Lodash.svg',
        name: 'Lodash',
    ...
    [
        {
            logo: '/front-end/statistic/other/Bootstrap.ico',
            name: 'Bootstrap',
...
export const website3 = [
    {
        logo: '/front-end/statistic/other/Apipost.ico',
        name: 'Apipost',
        url: 'https://www.apipost.cn/',
        description: 'API设计、调试、文档、自动化测试'
    },
    {
        logo: '/front-end/statistic/other/Apifox.png',
        name: 'Apifox',
        url: 'https://apifox.com/',
        description: 'API设计、开发、测试一体化'
    },
    {
        logo: '/front-end/statistic/other/Swagger.svg',
        name: 'Swagger',
        url: 'https://swagger.io/',
        description: '生成、调用API接口文档'
    },
    {
        logo: '/front-end/statistic/other/Postman.png',
        name: 'Postman',
        url: 'https://www.postman.com/',
        description: '生成、调用API接口文档'
    },
    {
        logo: '/front-end/statistic/other/YApi Pro.png',
        name: 'YApi Pro',
        url: 'https://yapi.pro/',
        description: '接口API管理',
    ...
    {
        logo: '/front-end/statistic/other/Eolink.ico',
        name: 'Eolink',
        url: 'https://wasa.w.dev.test.eolinker.com/',
        description: 'API管理、测试'
    },
    {
        logo: '/front-end/statistic/other/ShowDoc.ico',
        name: 'ShowDoc',
    ...
    {
        logo: '/front-end/statistic/other/Rap2.png',
        name: 'Rap2',
...
export const website4 = [
    ...
    [
        {
            logo: '/front-end/statistic/other/ECharts.png',
            name: 'ECharts',
        ...
        {
            logo: '/front-end/statistic/other/echarts-eg1-PPChart.ico',
            name: '例1',
            url: 'https://ppchart.com/#/',
            description: 'PPChart，ECharts案例汇总'
        },
        {
            logo: '/front-end/statistic/other/echarts-eg2.png',
            name: '例2',
            url: 'https://www.makeapie.cn/echarts',
            description: 'ECharts案例汇总'
        },
        {
            logo: '/front-end/statistic/other/echarts-eg3-MCChart.ico',
            name: '例3',
            url: 'https://echarts.zhangmuchen.top/#/index',
            description: 'MCChart，ECharts案例汇总'
        },
        {
            logo: '/front-end/statistic/other/echarts-eg4.png',
            name: '例4',
            url: 'http://chart.majh.top/',
            description: 'ECharts案例汇总'
        },
        {
            logo: '/front-end/statistic/other/echarts-eg5.ico',
            name: '例5',
    ...
    {
        logo: '/front-end/statistic/other/D3.png',
        name: 'D3',
        url: 'https://d3js.org/',
